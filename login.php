...
<body>
    ...
    <main>
        ...
        <div class="card-conteudo card-formulario">

            <h1>Entrar no Game Center</h1>
            ...
            if ($sucesso !== "") {
                ...
                echo '<p class="mensagem-sucesso"><i>✅ ' . $sucesso . ' ✅</i></p>';
            ...
            <form action="processar_login.php" method="post">
                ...
                <input
                    type="submit"
                    value="Entrar"
                    class="w3-button botao-login formulario-botao"
                >
