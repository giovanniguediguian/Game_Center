...
$sql = "select
        ...
        order by estatisticas.jokenpo desc, jogadores.nome asc
...
<head>
    ...
    <title>Ranking de Jokenpô - Game Center</title>
    ...
    <main>
        ...
        <div class="conteudo-ranking">
            ...
            <p class="descricao-ranking">
                ...
                Veja quem domina o Jokenpô no Game Center.
            ...
            <div class="botao-voltar-ranking">
                ...
                <?php } else { ?>
                    ...
                    <a href="../jogos/jokenpo.php" class="botao-voltar-ranking">
                        VOLTAR AO JOGO
                    </a>
