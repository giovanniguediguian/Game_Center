...
$sql = "select
        ...
        order by estatisticas.blackjack desc, jogadores.nome asc
...
<head>
    ...
    <title>Ranking de Blackjack - Game Center</title>
    ...
    <main>
        ...
        <div class="conteudo-ranking">
            ...
            <h1 class="titulo-ranking">
                ...
                RANKING DE BLACKJACK

            </h1>

            <p class="descricao-ranking">

                Veja quem domina o Blackjack no Game Center.
            ...
            <div class="botao-voltar-ranking">
                ...
                <?php } else { ?>
                    ...
                    <a href="../jogos/bj.php" class="botao-voltar-ranking">
                        VOLTAR AO JOGO
                    </a>
